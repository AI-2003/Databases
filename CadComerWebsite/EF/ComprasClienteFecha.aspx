...
<body>
    <form id="form1" runat="server">
        <div style="background-color: #D0E7D2; height: 634px;">
            <asp:Button ID="BtnLimpiar" runat="server" Style="z-index: 1; left: 330px; top: 485px; position: absolute" Text="Limpiar" OnClick="BtnLimpiar_Click" />
            <asp:Button ID="BtnEject" runat="server" Style="z-index: 1; left: 96px; top: 485px; position: absolute" Text="Ejecutar" OnClick="BtnEject_Click" />
            ...
            <asp:DropDownList ID="DdlCliente" runat="server" AutoPostBack="True" Style="z-index: 1; left: 173px; top: 160px; position: absolute" OnSelectedIndexChanged="DdlCliente_SelectedIndexChanged">
            </asp:DropDownList>
            ...
            <asp:Calendar ID="ClndrFecha" runat="server" ForeColor="#618264" Style="z-index: 1; left: 163px; top: 239px; position: absolute; height: 188px; width: 259px" OnSelectionChanged="ClndrFecha_SelectionChanged"></asp:Calendar>
            <asp:Label ID="LblProductos" runat="server" Font-Size="Large" ForeColor="#618264" style="z-index: 1; left: 696px; top: 489px; position: absolute"></asp:Label>
